myApp.controller('uploadFilesController', function ($scope, FileUploadService) {
    // Variables
    $scope.Message = "";
   ...
   myApp.factory('FileUploadService', function ($http, $q) { // explained abour controller and service in part 2
        ...
        fac.UploadFile = function (file, description) {
            ...
            var defer = $q.defer();//this means defer vraible will holds a deferred (a promise, or a result in the future, to be returned) that can be resolved or rejected whenever an asynchronous operation is done.  deferred contains the promise to be returned
